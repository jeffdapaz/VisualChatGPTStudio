...
namespace OpenAI_API.Chat
{
    ...
    public class Conversation
    {
        ...
        public void ReplaceLastUserInput(object content)
        {
            if (Messages.LastOrDefault(m => m.rawRole == "user") is { } lastMessage)
            {
        ...
        {
            if (!tools.Any(t => t.Function.Description == functionRequest.Function.Description))
            {
        ...
        /// </summary>
        public void AppendToolMessage(FunctionResult result, string content)
            ...
            [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            while (retrying && !cancellationToken.IsCancellationRequested)
            {
                ...
                do
                {
                    ...
                    if (delta?.rawRole != null && responseRole == null)
                    {
